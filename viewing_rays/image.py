...
class Image:
    ...
    @staticmethod
    def generate_spheres_image(spheres, matrix, image_size, lamp, sensibility, environment):
        ...
        for index, value in numpy.ndenumerate(matrix):
            ...
            for sphere in spheres:
                ...
                if sphere.hit(value[0], value[1]):
                    ...
                    if t < smaller_t:
                        smaller_t = t
                        color = sphere.blihn_pmong(value[0], value[1], smaller_t, lamp, sensibility, environment)
